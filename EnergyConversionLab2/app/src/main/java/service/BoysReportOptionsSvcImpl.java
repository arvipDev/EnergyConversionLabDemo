...
public class BoysReportOptionsSvcImpl implements IOption
{
    ...
    public BoysReportOptionsSvcImpl(Activity activity)
    {
    ...
    public void createFile(String filename)
    {
        ...
        String five = bundle.getString("five");
        String six = bundle.getString("six");
        String seven = bundle.getString("seven");

        List<String> row1 = new ArrayList<>();
        row1.add("Experiment - Boys gas calorimeter" + "\n");
        row1.add("Readings -");
        row1.add("Water flow rate Ww in Kg/sec = " + one);
        row1.add("Initial gas weight W1 in Kg = " + two);
        row1.add("Final gas weight W2 in Kg = " + three);
        row1.add("Time for gas to reach from W1 to W2 in seconds = " + four);
        row1.add("Water inlet temp T1 in Kg = " + five);
        row1.add("Water outlet temp T2 in Kg = " + six + "\n");
        row1.add("Result -");
        row1.add(seven  + "\n");
        row1.add("-----------------------------------------------------");
                ...
                layout_options_new_b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (new_reportName.isEmpty() || new_reportName.equals(null)) {
                            Toast.makeText(activity, "Invalid name - either file already exists or the field is empty",
                                    Toast.LENGTH_LONG).show();
                        } else {
