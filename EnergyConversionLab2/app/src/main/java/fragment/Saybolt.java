...
public class Saybolt extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        TextView redwood_tv_title = (TextView)rootView.findViewById(R.id.redwood_tv_title);
        redwood_tv_title.setText("Saybolt Viscometer");
            ...
            case R.id.redwood_b_results:
                ...
                if(!error)
                {
                    ...
                    else
                    {
                        ...
                        bundle.putBoolean("isSaybolt", true);
